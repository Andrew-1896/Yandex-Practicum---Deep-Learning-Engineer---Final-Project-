...
(**ВАЖНО:** для наиболее эффективной и быстрой работы рекомендуется использовать версии torch==2.5.1+cu124 и torchvision==0.20.1+cu124 (или другие, которые поддерживают работу с GPU; отсутсвуют в требованиях requirements, но нужны для эффективной работы).

**Как использовать:** скачать репозиторий и запустить ноутбук (файл Final_project_calories_predictions). 

**ВАЖНО:** для наиболее эффективной и быстрой работы рекомендуется использовать версии torch и torchvision, поддерживающие работу с GPU — см. чуть выше в п. 4) в описании файла requirements.
